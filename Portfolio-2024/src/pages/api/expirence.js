export async function GET() {
  return new Response(
    JSON.stringify([
      {
        title: "Desarrollador FullStack ChileCompra - Santiago, 2024-2026",
        descriptions: [
          ...
          "Desarrollador Back-end en Spring Boot, con experiencia en la creación de APIs RESTful, integración de bases de datos y optimización del rendimiento del servidor.",
        ],
        key: "2026",
      },
      {
